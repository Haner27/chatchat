...
@with_session
def create_chat_log(session, uid: int, req: str, resp: str, dialogue_mode: str) -> ChatLogModel:
...
@with_session
def query_chat_logs(session, uid: int = 0, offset: int = 0, limit: int = 10) -> list[ChatLogModel]:
